var ScrollReveal = function() {
    ...
    function i(e, t) {
        ...
        if (n(e)) return [e];
        if (i = e, r = Object.prototype.toString.call(i), "object" == typeof window.NodeList ? i instanceof window.NodeList : null !== i && "object" == typeof i && "number" == typeof i.length && /^\[object (HTMLCollection|NodeList|Object)\]$/.test(r) && (0 === i.length || n(i[0]))) return Array.prototype.slice.call(e);
        var i, r;
    ...
    function o(e, t) {
        if (r(e)) return Object.keys(e).forEach((function(n) {
            return t(e[n], n, e)
        }));
        if (e instanceof Array) return e.forEach((function(n, i) {
            return t(n, i, e)
        }));
    ...
    function m(e, t) {
        ...
        e.callbackTimer && (s = Date.now() - e.callbackTimer.start, window.clearTimeout(e.callbackTimer.clock)), r(e.node), e.callbackTimer = {
            ...
            clock: window.setTimeout((function() {
                o(e.node), e.callbackTimer = null, e.revealed && !e.config.reset && e.config.cleanup && c.call(n, e.node)
            }), i - s)
        }
    }
    var y, v = (y = 0, function() {
        return y++
    });
    ...
    function g(e, t) {
        ...
        var n = this.store.sequences[e.sequence.id],
            i = e.sequence.index;
        if (n) {
            var r = new w(n, "visible", this.store),
                o = new w(n, "revealed", this.store);
            if (n.models = {
                    visible: r,
                    revealed: o
                }, !o.body.length) {
                ...
                if (a) return E.call(this, n, r.body[0], -1, t), E.call(this, n, r.body[0], 1, t), p.call(this, a, {
                    reveal: !0,
                    pristine: t
                })
            }
            if (!n.blocked.head && i === [].concat(o.head).pop() && i >= [].concat(r.body).shift()) return E.call(this, n, i, -1, t), p.call(this, e, {
                reveal: !0,
                pristine: t
            });
            if (!n.blocked.foot && i === [].concat(o.foot).shift() && i <= [].concat(r.body).pop()) return E.call(this, n, i, 1, t), p.call(this, e, {
                reveal: !0,
                pristine: t
            })
        }
    ...
    function w(e, t, n) {
        var i = this;
        this.head = [], this.body = [], this.foot = [], o(e.members, (function(e, r) {
            var o = n.elements[e];
            o && o[t] && i.body.push(r)
        })), this.body.length && o(e.members, (function(e, r) {
            var o = n.elements[e];
    ...
    function E(e, t, n, i) {
        ...
        e.blocked[o] = !0, setTimeout((function() {
            e.blocked[o] = !1, a && g.call(r, a, i)
        }), e.interval)
    }

    function j() {
        var e = this;
        a.call(this), o(this.store.elements, (function(e) {
    ...
    function O(e) {
        for (var t = [], n = arguments.length - 1; 0 < n--;) t[n] = arguments[n + 1];
        if (r(e)) return o(t, (function(t) {
            o(t, (function(t, n) {
                r(t) ? (e[n] && r(e[n]) || (e[n] = {}), O(e[n], t)) : e[n] = t
            }))
        })), e;
    ...
    function k(t, n, r) {
        ...
        var p, m = [],
            y = n.interval || e.interval;
        try {
            y && (p = new b(y));
            var g = i(t);
            if (!g.length) throw new Error("Invalid reveal target.");
            o(g.reduce((function(e, t) {
                var r = {},
                    s = t.getAttribute("data-sr-id");
                s ? (O(r, a.store.elements[s]), r.node.setAttribute("style", r.styles.inline.computed)) : (r.id = v(), r.node = t, r.seen = !1, r.revealed = !1, r.visible = !1);
                var y = O({}, r.config || a.defaults, n);
                if (!y.mobile && T() || !y.desktop && !T()) return s && c.call(a, r), e;
                var g, b = i(y.container)[0];
                if (!b) throw new Error("Invalid container.");
                return b.contains(t) && (null === (g = function(e) {
                    for (var t = [], n = arguments.length - 1; 0 < n--;) t[n] = arguments[n + 1];
                    var i = null;
                ...
                }(b, m, a.store.containers)) && (g = v(), m.push({
                    id: g,
                    node: b
                })), r.config = y, r.containerId = g, r.styles = function(e) {
                    ...
                    var s, a, c, p, m, y, v, g, b, w, E, j, T, O = parseFloat(t.opacity),
                        k = isNaN(parseFloat(i.opacity)) ? parseFloat(t.opacity) : parseFloat(i.opacity),
                        x = {
                            computed: O !== k ? "opacity: " + O + ";" : "",
                            generated: O !== k ? "opacity: " + k + ";" : ""
                        },
                        A = [];
                    if (parseFloat(i.distance)) {
                        var R = "top" === i.origin || "bottom" === i.origin ? "Y" : "X",
                            q = i.distance;
                        "top" !== i.origin && "left" !== i.origin || (q = /^-/.test(q) ? q.substr(1) : "-" + q);
                        var P = q.match(/(^-?\d+\.?\d?)|(em$|px$|%$)/g),
                            I = P[0];
                        switch (P[1]) {
                            case "em":
                                q = parseInt(t.fontSize) * I;
                                break;
                            case "px":
                                q = I;
                                break;
                            case "%":
                                q = "Y" === R ? e.node.getBoundingClientRect().height * I / 100 : e.node.getBoundingClientRect().width * I / 100;
                                break;
                            default:
                    ...
                    if (A.length) {
                        ...
                        }, A.unshift(L.computed.matrix);
                        var M = A.reduce(u);
                        L.generated = {
                            initial: L.property + ": matrix3d(" + M.join(", ") + ");",
                    ...
                    var N = {};
                    if (x.generated || L.generated.initial) {
                        N.property = h("transition"), N.computed = t[N.property], N.fragments = [];
                        var z = i.delay,
                            F = i.duration,
                            D = i.easing;
                        x.generated && N.fragments.push({
                            delayed: "opacity " + F / 1e3 + "s " + D + " " + z / 1e3 + "s",
                            instant: "opacity " + F / 1e3 + "s " + D + " 0s"
                        }), L.generated.initial && N.fragments.push({
                            delayed: L.property + " " + F / 1e3 + "s " + D + " " + z / 1e3 + "s",
                            instant: L.property + " " + F / 1e3 + "s " + D + " 0s"
                        }), N.computed && !N.computed.match(/all 0s/) && N.fragments.unshift({
                            delayed: N.computed,
                            instant: N.computed
                        });
                        var S = N.fragments.reduce((function(e, t, n) {
                ...
                }, p.members.push(r.id)), e.push(r)), e
            }), []), (function(e) {
        ...
        })), p && (this.store.sequences[p.id] = p), !0 !== r && (this.store.history.push({
            target: t,
            options: n
        }), this.initTimeout && window.clearTimeout(this.initTimeout), this.initTimeout = window.setTimeout(j.bind(this), 0))
    }
    var x, A = Math.sign || function(e) {
            return (0 < e) - (e < 0) || +e
        },
        R = (x = Date.now(), function(e) {
            var t = Date.now();
            16 < t - x ? e(x = t) : setTimeout((function() {
                return R(e)
            }), 0)
        }),
        q = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || R;
    ...
    function I(e, t) {
        ...
        void 0 === e && (e = {
            type: "init"
        }), void 0 === t && (t = this.store.elements), q((function() {
            ...
            o(n.store.containers, (function(e) {
                ...
                i && (e.geometry = P.call(n, e)), e.visible = function(e) {
                    void 0 === e && (e = {});
                ...
                e.sequence ? g.call(n, e) : p.call(n, e)
            })), n.pristine = !1
        }))
    }
    var L, M, N, z, F, D, S, C;
    ...
    function W(n) {
        var r;
        if (void 0 === n && (n = {}), void 0 === this || Object.getPrototypeOf(this) !== W.prototype) return new W(n);
        if (!W.isSupported()) return s.call(this, "Instantiation failed.", "This browser is not supported."), t;
        try {
            r = O({}, D || e, n)
        } catch (n) {
            return s.call(this, "Instantiation failed.", "Invalid configuration.", n.message), t
        }
        try {
            if (!i(r.container)[0]) throw new Error("Invalid container.");
            if (!r.mobile && T() || !r.desktop && !T()) throw new Error("This device is disabled.")
        } catch (n) {
            return s.call(this, "Instantiation failed.", n.message), t
        }
        return D = r, document.documentElement.classList.add("sr"), document.body ? document.body.style.height = "100%" : document.addEventListener("DOMContentLoaded", (function() {
            ...
            history: [],
            sequences: {}
        }, this.pristine = !0, L = L || I.bind(this), M = M || function() {
            var e = this;
            o(this.store.elements, (function(e) {
        ...
        }.bind(this), N = N || k.bind(this), z = z || c.bind(this), F = F || function() {
            var e = this;
            o(this.store.history, (function(t) {
                k.call(e, t.target, t.options, !0)
            })), j.call(this)
